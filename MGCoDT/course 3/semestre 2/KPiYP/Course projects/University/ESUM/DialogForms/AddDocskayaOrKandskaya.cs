...
namespace ESUM
{
    public partial class AddDocskayaOrKandskaya : Form
    {
        ...
        public AddDocskayaOrKandskaya(string title, string name, string date) : this(title)
        {
            Text = "Изменить " + title;
