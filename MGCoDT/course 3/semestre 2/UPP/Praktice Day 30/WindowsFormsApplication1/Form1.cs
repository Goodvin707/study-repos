...
namespace WindowsFormsApplication1
{
    ...
    {
        public string ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=..\\..\\Baza_ru.mdb";
        int act_table = 1; // активная таблица (1-билеты, 2-маршруты, 3-автобусы, 4-водители, 5 - диспетчеры
        public Form1()
        {
            InitializeComponent();
        }
