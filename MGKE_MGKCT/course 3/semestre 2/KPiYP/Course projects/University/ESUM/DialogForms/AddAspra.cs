...
namespace ESUM
{
    public partial class AddAspra : Form
    {
        ...
        public AddAspra()
        {
            ...
            myCommand.CommandText = "SELECT Фамилия, Имя, Отчество, Категория FROM Преподаватели Where Категория = 'ассистент'";
        ...
        public AddAspra(string date) : this()
        {
            Text = "Изменить аспирантуру";
